...
public class PlutoplateView
{
  ...
  private JLabel noPhidgets = new JLabel("<html><font color=\"white\">No Motors Connected. Please connect to start.</font></html>", 0);
  ...
  public void createView()
  {
    ...
    this.viewframe.addWindowListener(new WindowListener()
    {
      ...
      public void windowClosing(WindowEvent e)
      {
        ...
        {
          JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.getDescription(), "Error Closing Phidget: " + ex.getErrorNumber(), 0);
        }
      }
      ...
      public void windowOpened(WindowEvent e)
      {
        ...
        {
          JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.getDescription(), "Error Initializing Phidget: " + ex.getErrorNumber(), 0);
        }
      }
    });
    ...
    panel.setPreferredSize(new Dimension(backgroundImage.getWidth(null) - 10, backgroundImage.getHeight(null) - 10));
    ...
    this.motorPosition.addMouseListener(new MouseListener()
    {
      ...
      public void mouseReleased(MouseEvent arg0)
      {
        if (PlutoplateView.this.motorPosition.isEnabled()) {
          try
          {
            PlutoplateView.this.controller.updatePosition(Integer.valueOf(PlutoplateView.this.motorPosition.getValue()));
            PlutoplateView.this.motorPosition.setEnabled(false);
          }
          catch (PhidgetException ex)
          {
            JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.getDescription(), "Error Altering Motor Position: " + ex.getErrorNumber(), 0);
          }
        }
      }
    });
    ...
    this.resetPosition.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        {
          JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.getDescription(), "Error Resetting Position: " + ex.getErrorNumber(), 0);
        }
      }
    });
    ...
    this.saveAsPreset.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
            ...
            if (name != null)
            {
              if (name.length() > 0)
              {
                if (PlutoplateView.this.model.getPresetDB().getPreset(name) == null)
                {
                  ...
                  if ((PlutoplateView.this.actualPosition.getText() != null) && (PlutoplateView.this.actualPosition.getText().length() != 0)) {
                    position = Integer.valueOf(Integer.parseInt(PlutoplateView.this.actualPosition.getText()));
                  }
                ...
                {
                  name = JOptionPane.showInputDialog(PlutoplateView.this.viewframe, "Preset Name '" + name + "' Is Already Taken.\nPlease Enter Another:");
                }
              }
              else {
                name = JOptionPane.showInputDialog(PlutoplateView.this.viewframe, "Preset Name(Required):");
              }
            }
            else {
              closePane = true;
        ...
        {
          JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.toString(), "Error Saving Preset: " + ex.toString(), 0);
        }
      }
    });
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(new JLabel("<html><font color=\"white\">Target:</font></html>")).addComponent(this.targetPosition)).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(new JLabel("<html><font color=\"white\">Current:</font></html>")).addComponent(this.actualPosition)).addComponent(this.saveAsPreset));
  ...
  private void constructHelp()
  {
    ...
    infoSubMenu.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, "Version 1.1.0 - 2014", "About" + PlutoplateView.FRAME_LABEL, 1);
      }
    });
      ...
      for (PlutoplatePreset preset : this.model.getPresetDB().getPresets())
      {
        ...
        menuItem.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            ...
            {
              JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, ex.getDescription(), "Error Opening '" + presetName + "' Preset: " + ex.getErrorNumber(), 0);
            }
          }
        });
        ...
        menuItem.addActionListener(new ActionListener()
        {
          public void actionPerformed(ActionEvent e)
          {
            ...
            JMenu parent = (JMenu)parentPopup.getInvoker();
            presetName = parent.getText();
            int response = JOptionPane.showConfirmDialog(PlutoplateView.this.viewframe, "Are you sure you would like to delete '" + presetName + "'?", "Confirm", 0, 3);
            if (response == 0)
            {
